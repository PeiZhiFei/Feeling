...
public class FloatingActionButton extends ImageButton {
    ...
    @IntDef({SIZE_NORMAL, SIZE_MINI, SIZE_LARGER})
    ...
    private void updateCircleSize() {
        ...
        } else if (mSize == SIZE_LARGER) {
            mCircleSize = getDimension(R.dimen.fab_size_larger);
        }
    }

    public void setSize(@FAB_SIZE int size) {
        if (size != SIZE_MINI && size != SIZE_NORMAL && size != SIZE_LARGER) {
    ...
    void updateBackground() {
        ...
        switch (mSize) {
            case SIZE_NORMAL:
                x = R.drawable.fab_bg_normal;
                break;
            case SIZE_MINI:
                x = R.drawable.fab_bg_mini;
                break;
            case SIZE_LARGER:
                x = R.drawable.fab_bg_larger;
                break;
            default:
                x = R.drawable.fab_bg_normal;
        }
