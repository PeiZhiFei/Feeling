...
public class NewtonCradleLoading extends LinearLayout
{
    ...
    private void initView(Context context) {
        LayoutInflater.from(context).inflate(R.layout.widget_newton, this, true);
    }
        ...
        rotateLeftAnimation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                if (isStart) {
                    ...
                    cradleBallFour.startAnimation(rotateRightAnimation);
                }
            }
    ...
    public void setText(String s) {
        ...
        cradleBallOne.setText(a);
        cradleBallTwo.setText(b);
        cradleBallThree.setText(c);
        cradleBallFour.setText(d);
    }
}
