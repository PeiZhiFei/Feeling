 ...
 */
package library.widget.smartlayout;
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0, size = mTabStrip.getChildCount(); i < size; i++) {
                View selectView = mTabStrip.getChildAt(i);
                selectView.setSelected(position == i);
                if ((selectView instanceof TextView) && (i == position)) {
                    ((TextView) selectView).setTextColor(mSelectedTabTextColor);
                } else if ((selectView instanceof TextView)) {
                    ((TextView) selectView).setTextColor(mTabViewTextColor);
                }
            }
