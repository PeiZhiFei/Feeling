...
import library.widget.refreshview.indicator.PtrIndicator;
import my.library.R;
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    private String pulldownText, pulldownRefreshText, pulldownReleaseText, refreshText, refreshCompleteText;
    ...
    private void initText() {
        pulldownText = getContext().getResources().getString(R.string.cube_ptr_pull_down);
        pulldownRefreshText = getContext().getResources().getString(R.string.cube_ptr_pull_down_to_refresh);
        pulldownReleaseText = getContext().getResources().getString(R.string.cube_ptr_release_to_refresh);
        refreshText = getContext().getResources().getString(R.string.cube_ptr_refreshing);
        refreshCompleteText = getContext().getResources().getString(R.string.cube_ptr_refresh_complete);
    }
    ...
    public void onUIRefreshPrepare(PtrFrameLayout frame) {
        ...
        if (frame.isPullToRefresh()) {
            mTitleTextView.setText(pulldownRefreshText);
        } else {
            mTitleTextView.setText(pulldownText);
        }
    }
    ...
    public void onUIRefreshBegin(PtrFrameLayout frame) {
        ...
        mTitleTextView.setVisibility(VISIBLE);
        mTitleTextView.setText(refreshText);
    ...
    public void onUIRefreshComplete(PtrFrameLayout frame) {
        ...
        mTitleTextView.setVisibility(VISIBLE);
        mTitleTextView.setText(refreshCompleteText);
    ...
    private void crossRotateLineFromTopUnderTouch(PtrFrameLayout frame) {
        if (!frame.isPullToRefresh()) {
            mTitleTextView.setVisibility(VISIBLE);
            mTitleTextView.setText(pulldownReleaseText);
        }
    }
    ...
    public void setText(String[] text) {
        pulldownText = text[0];
        pulldownRefreshText = text[1];
        pulldownReleaseText = text[2];
        refreshText = text[3];
        refreshCompleteText = text[4];
    }
