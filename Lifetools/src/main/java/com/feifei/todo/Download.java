...
public class Download {
    ...
    void download (Context context, String url) {
        ...
        this.url = url;
        dialog = new Dialog (context, R.style.dialog_trans_style);
        ...
        dialog.setContentView (v, new android.view.ViewGroup.LayoutParams ((int) ((double) DeviceUtil.getWidth(context) * 0.9D), DeviceUtil.dp2px(context, 50)));
        dialog.show ();
        ...
        public void run () {
            try {
                if (Environment.getExternalStorageState ().equals (
                    ...
                    File apkFile = new File (savePath, "todo.apk");
                    if (!apkFile.exists ()) {
