...
//            LogUtil.log("已发送");
     ...
     * @param phone
     * @param message
     * @param sentIntent      ：发送成功的intent
     * @param deliveredIntent ：接受成功的intent
    ...
    private static void sendSMS(String phone, String scAddress, String message, PendingIntent sentIntent, PendingIntent deliveredIntent) {
        SmsManager smsMgr;
    ...
    public static String getSmsInPhone(Context context) {
        ...
        try {
            ...
            Log.e("getSmsException", ex.getMessage());
        }
