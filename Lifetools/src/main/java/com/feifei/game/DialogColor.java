...
public class DialogColor extends DialogFragment implements View.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        MaterialDialog dialog = new MaterialDialog.Builder(getActivity())
                .title("请选择颜色")
                .autoDismiss(false)
                .customView(R.layout.d_chooser, false)
                .build();
    ...
    public void onAttach(Activity activity) {
        ...
        if (!(activity instanceof Callback))
            throw new RuntimeException("The Activity must implement Callback to be used by DialogColor.");
